	...
	float screenDepth, float screenNear)
{
	...
	//STARTING DIRECTX INITIALIZATION
	...
	// D3D_DRIVER_TYPE_REFERENCE if we want to draw with CPU
...
void D3DClass::CleanupRenderTarget()
{
...
void D3DClass::BeginScene(float red, float green, float blue, float alpha)
{
	...
	m_deviceContext->ClearDepthStencilView(m_depthStencilView, D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL, 1.0f, 0u);
