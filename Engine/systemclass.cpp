...
bool SystemClass::Initialize()
{
	...
	m_gui = m_Application->m_Zone->m_GUI;
	t = true;
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	m_hwnd = CreateWindow(wc.lpszClassName, L"Engine", WS_OVERLAPPEDWINDOW, posX, posY, screenWidth, screenHeight, NULL, NULL, wc.hInstance, NULL);
