...
bool LightShaderClass::Render(ID3D11Device* device,ID3D11DeviceContext* deviceContext,
	...
	XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower)
{
	...
	result = SetShaderParameters(device, deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, lightDirection, diffuseColor, ambientColor,
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* psFilename)
{
	...
	// Compile the vertex shader code.					//TextureVertexShader
	...
	//D3D11_FILTER_MIN_MAG_MIP_LINEAR is expensive!
...
bool LightShaderClass::SetShaderParameters(ID3D11Device* device, ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
