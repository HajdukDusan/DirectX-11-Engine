...
bool SpriteClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth,
	int screenHeight,const char* textureFilename, int spriteWidth, int spriteHeight)
{
	bool result;
...
bool SpriteClass::LoadTexture(ID3D11Device* device, ID3D11DeviceContext* deviceContext, const char* filename)
{
	bool result;
